...
namespace Interface
{
    public partial class formSorteio : Form
    {
        ...
        private void button_sortear_Click(object sender, EventArgs e)
        {
            ...
            {
                dgv_resultadoSorteio.Rows.Add(listaEquipesSelecionadas[listaSorteados[j]].Cells[0].Value.ToString(), listaEquipesSelecionadas[listaSorteados[j]].Cells[1].Value.ToString(), (dgv_resultadoSorteio.Rows.Count + 1).ToString()+"ª"); ;
            }
